...
router.get("/ca-transactions", (req, res) => {
  ...
  authenticate(req, res, () => caTransactionController.getCaTransactions(req, res));
});

router.post("/ca-transactions", (req, res) => {
  req.requiredPermissions = ['CreateCaTransaction'];
  authenticate(req, res, () => caTransactionController.createCaTransaction(req, res));
});

router.get("/ca-transactions/:id", (req, res) => {
  req.requiredPermissions = ['GetCaTransactionById'];
  authenticate(req, res, () => caTransactionController.getCaTransactionById(req, res));
});
